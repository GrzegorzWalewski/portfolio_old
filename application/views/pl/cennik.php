<div class="uk-width-4-5 content uk-text-center uk-text-middle">
    ...
    <div class="uk-grid">
        <div class="uk-width-3-3 text_side kontakt">
            <h1 class="text_title text">KONTAKT</h1>
            <div class="contact">
                <div class="uk-card">
            ...
            <div>
                <form method="post" id="messageForm" action="/pl/cennik">
                    <fieldset class="uk-fieldset">
                        <div class="uk-margin">
                            <input class="uk-input" name="name" id="name" type="text" placeholder="Twoje imię">
                        </div>
                        <div class="uk-margin">
                            <input class="uk-input" name="mail" id="mail" type="text" placeholder="E-Mail">
                        </div>
                        <div class="uk-margin">
                            <textarea class="uk-textarea" rows="5" name="mess" id="mess" placeholder="Wiadomość"></textarea>
                        </div>
                        <div class="uk-margin">
                            <input id="submit_button" class="uk-submit uk-button" type="submit" value="Wyślij"></input>
                        </div>
                    </fieldset>
                </form>
            </div>
